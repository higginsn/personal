...
  init() {
    this.showIntro();
    document.getElementById('start-short-btn').addEventListener('click', () => {
      this.startQuiz(CONFIG.testMode ? CONFIG.testQuestionCount : 10);
    });
    document.getElementById('start-long-btn').addEventListener('click', () => {
      this.startQuiz(CONFIG.testMode ? CONFIG.testQuestionCount : 25);
    });
